          ...
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div className="col-lg-6">
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                <button type="button" className="btn btn-primary btn-lg px-4 me-md-2" onClick={goToRegister}>Sign up</button>
                <button type="button" className="btn btn-outline-secondary btn-lg px-4" onClick={goToLogin}>Log in</button>
              </div>
            </div>
          </div>
        </div>
